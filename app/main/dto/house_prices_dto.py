...
class HousePricesDto:
    ...
    house_prices = api.model('house_prices', {
        ...
        'view': fields.Boolean(required=True, description='If the house has been viewed or not 0 means no 1 means yes'),
        ...
        'waterfront': fields.Boolean(required=True, description='Determines whether a house has a view to waterfront\
                                                            0 means no 1 means yes.'),
        'floors': fields.Integer(required=True, description='Total floors means levels of house'),
        'renovated': fields.Boolean(required=True, description='If the house has been renovated or not\
                                                                0 means no 1 means yes'),
