...
class HousePricesDto:
    ...
    house_prices = api.model('house_prices', {
        ...
        'lat': fields.Integer(required=True, description='Latitude of the location of the house'),
        ...
        'waterfront': fields.Integer(required=True, description='Determines whether a house has a view to waterfront\
                                                                0 means no 1 means yes.'),
        'sqft_lot15': fields.Integer(required=True, description='Predicted price'),
        ...
        'long': fields.Integer(required=True, description='Longitude of the location of the house'),
